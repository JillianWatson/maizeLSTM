...
cluster_yearly_aggregates <- readRDS("model/aggregate_data/cluster_yearly_aggregates.rds")
...
saveRDS(feature_stats, "model/old_workflow/old_standardization_outputs/OLDfeature_stats.rds")
#write_csv(feature_stats, "py_model/standardized_data_stats.csv")
saveRDS(standardized_data, "model/old_workflow/old_standardization_outputs/OLDstandardized_yearly_aggregates.rds")
saveRDS(model_ready_data, "model/old_workflow/old_standardization_outputs/OLDmodel_ready_data.rds")

write.csv(model_ready_data, "model/old_workflow/old_standardization_outputs/OLDstandardized_data.csv", row.names = FALSE)

cat("\nStandardization complete!\n")
cat("- Full data with standardized features saved to: model/old_workflow/old_standardization_outputs/OLDstandardized_yearly_aggregates.rds\n")
cat("- Model-ready data with only standardized features saved to: model/old_workflow/old_standardization_outputs/OLDmodel_ready_data.rds\n")
cat("- Feature statistics saved to: model/old_workflow/old_standardization_outputs/OLDfeature_stats.rds\n")
